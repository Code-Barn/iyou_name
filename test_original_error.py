...
# Test the original error scenario - calling with user_settings as both positional and keyword
print("Testing original error scenario...")
try:
    # This should NOT cause "multiple values for argument 'user_settings'" error anymore
    result = generate_1gen_preview(
        mock_individual,
        mock_family_data,
        user_settings={'font_family': 'Arial'}  # This was causing the error before
    )
    print('SUCCESS: No "multiple values for argument" error')
