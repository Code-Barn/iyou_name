    ...
    try:
        ...
        with Image(filename=preview_template_path, resolution=300) as content_img:
            ...
            with Drawing() as draw:
                ...
                # Draw grandparents along edges (simplified positioning)
                grandparents = [
                    (
                    ...
                    (
                        ...
                        "maternal_grandfather",
                        (1750 - edge_distance, 200),
                    ),  # Right edge
                    (
                        paternal_grandmother,
                        "paternal_grandmother",
                        (1750, 1750 - edge_distance),
                    ),  # Bottom edge
                    (
                ...
                for grandparent, gp_type, (x, y) in grandparents:
                    if grandparent:
                        print(f"Drawing {gp_type}: {grandparent.full_name}")
                        ...
                        # Draw grandparent name parts separately
                        if first_name:
                            draw.push()
                            draw.translate(x, y)
                            draw.text(0, 0, first_name)
                            print(f"Drew {gp_type} first name: '{first_name}'")
                            draw.pop()
                        ...
                        if last_name:
                            ...
                            print(f"Drew {gp_type} last name: '{last_name}'")
                            draw.pop()

                        # Draw birth date if available
                        if grandparent.birth_date:
                            draw.push()
                            draw.translate(x, y + date_distance)
                            draw.font_size = int(
                                font_size * 0.7
                            )  # Smaller font for dates
                            draw.text(0, 0, grandparent.birth_date)
                            print(
                                f"Drew {gp_type} birth date: '{grandparent.birth_date}'"
                            )
                            draw.pop()
            ...
            print(f"DEBUG: Generating 2gen overlay with settings: {primary_settings}")
            ...
            overlay_scale = 0.35  # 35% scale like the working backup
