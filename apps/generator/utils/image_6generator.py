...
def generate_family_tree(primary_individual, family_data, template="6gen"):
    ...
    Args:
        ...
        template: Template type (e.g., '6gen' for 6-generation chart)
    ...
    try:
        ...
        with Image(filename=template_path, resolution=300) as img:
            ...
            # =============================================
            # 2x GREAT-GRANDPARENT GENERATION TUNING SETTINGS
            # =============================================
            ...
            with Drawing() as draw:
                ...
                print(
                    f"Translating coordinates by (x={TWO_G_GRANDPARENT_TRANSLATE_X}, y={TWO_G_GRANDPARENT_TRANSLATE_Y})"
                )
                draw.translate(
                    x=TWO_G_GRANDPARENT_TRANSLATE_X, y=TWO_G_GRANDPARENT_TRANSLATE_Y
                )
                print(f"Setting fill_color to: {TWO_G_GRANDPARENT_FONT_COLOR}")
                draw.fill_color = TWO_G_GRANDPARENT_FONT_COLOR
                print(f"Setting font_size to: {TINY_FONT_SIZE}")
                draw.font_size = TINY_FONT_SIZE

                # Initialize variables for 2x great-grandparents (32 individuals)
                # This would include all the 3x great-grandparents from the 7gen chart
                # For now, we'll include placeholder drawing code for a few key individuals

                # Placeholder for drawing 32 individuals
                print("Drawing 2x great-grandparent generation (32 individuals)")
                # In a real implementation, this would include detailed drawing code for each of the 32 individuals
                # Similar to the pattern used for great-grandparents but with more individuals
        ...
        with Image(filename=template_path, resolution=300) as img:
            ...
            # =============================================
            # 3x GREAT-GRANDPARENT GENERATION TUNING SETTINGS
            # =============================================
            ...
            # These will need to be tuned for proper positioning
            # For 64 individuals, we'd need extensive tuning variables
            ...
            with Drawing() as draw:
                ...
                print(
                    f"Translating coordinates by (x={THREE_G_GRANDPARENT_TRANSLATE_X}, y={THREE_G_GRANDPARENT_TRANSLATE_Y})"
                )
                draw.translate(
                    x=THREE_G_GRANDPARENT_TRANSLATE_X, y=THREE_G_GRANDPARENT_TRANSLATE_Y
                )
                print(f"Setting fill_color to: {THREE_G_GRANDPARENT_FONT_COLOR}")
                draw.fill_color = THREE_G_GRANDPARENT_FONT_COLOR
                print(f"Setting font_size to: {MINI_FONT_SIZE}")
                draw.font_size = MINI_FONT_SIZE

                # Placeholder for drawing 64 individuals (3x great-grandparents)
                print("Drawing 3x great-grandparent generation (64 individuals)")
                # In a real implementation, this would include detailed drawing code for each of the 64 individuals
                # Similar to the pattern used for previous generations but with more individuals
