def generate_family_tree(primary_individual, family_data, template="1gen", user_settings=None):
    ...
    try:
        ...
        with Image(filename=template_path, resolution=300) as img:
            ...
            PRIMARY_BIRTH_PLACE_COLOR = Color(user_settings.get("primary_place_color", "black"))
            ...
            PRIMARY_BIRTH_PLACE_X = int(user_settings.get("primary_place_x", 0))
            PRIMARY_BIRTH_PLACE_Y = int(user_settings.get("primary_place_y", 90))
            PRIMARY_BIRTH_PLACE_ROTATE = int(user_settings.get("primary_place_rotate", -45))
            ...
            with Drawing() as draw:
                ...
                draw.text(pifx_death_place, pify_death_place, primary_individual.death_date or " ")
                print(f"Drawn text at ({pifx_death_place}, {pify_death_place}): {primary_individual.death_date or ' '}")
