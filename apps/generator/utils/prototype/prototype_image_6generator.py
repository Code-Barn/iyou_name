...
class Generation6Constants:
    ...
    GREAT_GREAT_GREAT_GRANDPARENT_NAME_FONT_SIZE = 9
...
GENERATION_6_SETTINGS_SCHEMA = {
    ...
    "great_great_great_grandparent_stroke_width": (float, 0.0),
        ...
        with Image(
            ...
            with Drawing() as draw:
                ...
                draw.stroke_width = validated_settings.get(
                    "great_great_great_grandparent_stroke_width", 0.0
                )
                ...
                base_params = dict(
                    ...
                    birth_date_paired_offset_x=-50,
                    death_date_paired_offset_x=50,
                    paired_dates_base_y=1798,
                    paired_places_base_y=1939,
                    birth_place_paired_offset_x=-60,
